...
public class Asn1VisibleString extends Asn1Field implements PrimitiveAsn1Field {
    ...
    private Asn1VisibleString() {
        super(null, TagClass.UNIVERSAL, TagConstructed.PRIMITIVE, UniversalTagNumber.VISIBLESTRING);
    }

    public Asn1VisibleString(String identifier) {
        super(
                identifier,
                TagClass.UNIVERSAL,
    ...
    public Asn1VisibleString(String identifier, int implicitTagNumber) {
