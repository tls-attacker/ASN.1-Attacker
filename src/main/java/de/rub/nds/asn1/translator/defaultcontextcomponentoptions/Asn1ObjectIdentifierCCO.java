...
public class Asn1ObjectIdentifierCCO extends ContextComponentOption<Asn1ObjectIdentifier> {
    ...
    public Asn1ObjectIdentifierCCO() {
        super(TagClass.UNIVERSAL.getIntValue(), TagConstructed.PRIMITIVE.getBooleanValue(), TagNumber.OBJECT_IDENTIFIER
            .getIntValue(), false, Asn1ObjectIdentifierFT.class, null);
    }
}