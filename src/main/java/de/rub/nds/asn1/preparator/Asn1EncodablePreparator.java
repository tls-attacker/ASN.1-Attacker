 ...
 *
 */
public class Asn1EncodablePreparator {
    ...
    public static Asn1Encodable copyAsn1Encodable(Asn1Encodable asn1Encodable)
        ...
        Asn1EncodablePreparator.write(stream, asn1Encodable);
        stream.flush();
        Asn1Encodable copiedAsn1Encodable =
            Asn1EncodablePreparator.read(new ByteArrayInputStream(stream.toByteArray()));
        return copiedAsn1Encodable;
    }

    private Asn1EncodablePreparator() {
    }
